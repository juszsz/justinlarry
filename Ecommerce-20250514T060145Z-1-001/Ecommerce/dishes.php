...
?>								  
                                ...
                                <div class="widget-body">
                                    <div class="price-wrap text-xs-center">
                                        <p>TOTAL</p>
                                        <h3 class="value" style='color: black;'><strong><?php echo "₱".$item_total; ?></strong></h3>
                                        <p>Free Delivery!</p>
                                        <?php
                                        if($item_total==0){
                                        ?>
                                        ...
                                        <a href="checkout.php?res_id=<?php echo $_GET['res_id'];?>&action=check"  class="btn btn-danger btn-lg disabled" style="width: 130px;">Checkout</a>

                                        <?php
                                        }
                                        else{   
                                        ?>
                                        <a href="checkout.php?res_id=<?php echo $_GET['res_id'];?>&action=check"  class="btn btn-success btn-lg active" style="width: 130px;">Checkout</a>
                                        <?php   
                                        }
                                        ?>
                                ...
                                <div class="food-item">
                                    <div class="row">
										...
										<span class="price pull-left" >₱<?php echo $product['price']; ?></span>
										  ...
										  <input type="submit" class="btn theme-btn" style="margin-left:40px; width: 120px; margin-top: 5px;" value="Add To Cart" />
										</div>
										</form>
                                    </div>
